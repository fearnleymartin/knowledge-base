...
if __name__ == '__main__':
    ...
    path_data_set = '../Old_file/Data/test.json'
    path_train_output_directory = 'scripts/super_user_big_dataset/train.csv'
    path_test_output_directory = 'scripts/super_user_big_dataset/test.csv'
    path_valid_output_directory = 'scripts/super_user_big_dataset/valid.csv'
    path_train_data_set = '../Old_file/Data/train.json'
