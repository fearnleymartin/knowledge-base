...
tf.flags.DEFINE_string("input_dir", "scripts/super_user_big_dataset", "Directory containing input data files 'train.tfrecords' and 'validation.tfrecords'")
tf.flags.DEFINE_string("model_dir", None, "Directory to store model checkpoints (defaults to ./runs)")
tf.flags.DEFINE_integer("loglevel", 20, "Tensorflow log level")
tf.flags.DEFINE_integer("num_epochs", 1, "Number of training Epochs. Defaults to indefinite.")
