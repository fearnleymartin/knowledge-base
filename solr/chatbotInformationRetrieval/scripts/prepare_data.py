...
#                                               #
#  Run this script after running create_test_   #
#  validation_dataset to create files with      #
#  the correct format to train the RNN          #
#################################################
...
tf.flags.DEFINE_string(
  "input_dir", os.path.abspath("../scripts/super_user_big_dataset"),
  "Input directory containing original CSV data files (default = './data')")

tf.flags.DEFINE_string(
  "output_dir", os.path.abspath("./super_user_big_dataset"),
  "Output directory for TFrEcord files (default = './super_user_big_dataset')")

FLAGS = tf.flags.FLAGS

TRAIN_PATH = os.path.join(FLAGS.input_dir,'train.csv' )  #"ubuntu-ranking-dataset-creator/src/train.csv"
VALIDATION_PATH = os.path.join(FLAGS.input_dir, 'valid.csv' ) #"ubuntu-ranking-dataset-creator/src/valid.csv"
TEST_PATH = os.path.join(FLAGS.input_dir,'test.csv' ) #"ubuntu-ranking-dataset-creator/src/test.csv"
