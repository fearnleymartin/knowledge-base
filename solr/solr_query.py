...
#  Name : solr_query.py                         #
#                                               #
#  Contains all the usefull object to perform   #
#  querys on your SOLR database                 #
#################################################
...
To see an example of use you can see in folder Query/query_algo
'''
...
### SOME CODE EXAMPLE HOW TO USE OUR OBJECTS
...
solquery.clean_DB()
solquery.add_doc('Old_file/EvaluationDB/evaluation.json')
print('DB done')'''
